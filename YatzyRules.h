...
class YatzyRules
{
  public:   
	/**
	 * Constructs the yatzy rules
	 */
	YatzyRules();
	/**
	 * Copy-constructor. Does not actually copy anything since the class always contains the same stuff.
	 */
	YatzyRules(const YatzyRules& yr);
	/**
	...
	/**
	 * Assignment operator. Does nothing since the class always contains the same stuff.
	 */
	YatzyRules& operator=(const YatzyRules& yr);
